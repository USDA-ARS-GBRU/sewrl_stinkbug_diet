...
#SBATCH --job-name=bbmerge_1454
#SBATCH --output=bbmerge_1454_%j.out
#SBATCH -t 02:00:00
...
readdir="/project/gbru_fy24_stinkbug_diet/Illumina-1454"
filtered="results_1454/filtered-seqs"
merged="results_1454/merged"
unmerged="results_1454/unmerged"
results="results_1454"
threads=3

# Data has already been trimmed and low-quality sequences removed.
# List all the forward reads 
file_list=$(find ${filtered} -type f -name "GT*_L001_R1_001.fastq.gz")
